# %% [raw]
# ---
# title: "Low noise (0.05): 13,741 neurons, DAVIS visual input"
...
# %% [markdown]
# This notebook runs the full GNN pipeline for the FlyVis simulation with **low noise** ($\sigma = 0.05$).
#
...
#
# where $\sigma = 0.05$ and $\xi_i(t)$ is additive noise.
...
print()
print("=" * 80)
print("Low noise (0.05): 13,741 neurons, DAVIS visual input")
print("=" * 80)

config_file_ = 'flyvis_noise_005'
...
# Simulate the *Drosophila* visual system ODE with additive noise ($\sigma = 0.05$).
#
# **Outputs:**
#
...
# $\mathbf{a}_i \in \mathbb{R}^2$, $f_\theta$, $g_\phi$ from noisy observations.
#
