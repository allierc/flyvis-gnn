...
if __name__ == "__main__":
    ...
    n_iterations_default = len(FRAME_BLOCKS) * N_ITER_BLOCK  # 7 blocks * 12 = 84
    n_iterations = task_params.get('iterations', n_iterations_default)
...
# python INR_LLM.py -o train_inr_Claude_cluster flyvis_noise_005_INR_siren iterations=192 --cluster --resume