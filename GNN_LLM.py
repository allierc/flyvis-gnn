...
def check_cluster_repo():
    ...
    if diff_output:
        print(f"\033[91mERROR: GraphCluster repo has uncommitted changes — commit and push before running\033[0m")
...
Do NOT apply changes yet. Just propose and explain."""
    ...
    # Keep last proposal text so LLM has context for revisions
...
IMPORTANT: Do NOT change config YAML files — only source code (.py files)."""
            ...
            while applied:
                ...
                if val_input.lower() == 'accept':
                    ...
                    # Undo applied changes, return to proposal loop
                    ...
                    # Free-form feedback on applied code
...
After editing, summarize what you changed."""
            ...
            # Ask LLM for multiple approaches
...
Do NOT apply any changes. Just present the options clearly."""
            ...
            # Free-form feedback or suggestion — revise proposal
