# FlyVis Experiment Log: flyvis_63_1 (parallel)
...
### Batch 21 (Iter 77-80): Infrastructure Failure

## Iter 77: failed
Node: id=121, parent=120
Mode/Strategy: exploit
Config: lr_W=6E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=1100, coeff_W_L1=3E-5, coeff_W_L2=2E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: field_R2=0.549, training_time_min=64 (partial — other metrics missing)
Embedding: N/A
Mutation: edge_diff: 1000 -> 1100 at N120 baseline
Parent rule: N120 has best V_rest (0.547), testing if edge_diff=1100 helps
Observation: **INFRASTRUCTURE FAILURE** — training completed but metrics calculation failed. Only field_R2 available. field_R2=0.549 suggests training succeeded.
Next: parent=120

## Iter 78: failed
Node: id=122, parent=120
Mode/Strategy: exploit (replication)
Config: lr_W=6E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=1000, coeff_W_L1=3E-5, coeff_W_L2=2E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: field_R2=0.552, training_time_min=64 (partial — other metrics missing)
Embedding: N/A
Mutation: EXACT REPLICATE N120 (edge_diff=1000, W_L2=2E-6)
Parent rule: Testing N120 reproducibility (V_rest=0.547)
Observation: **INFRASTRUCTURE FAILURE** — training completed, field_R2=0.552 matches N120 (0.553). Exact replicate shows consistency but metrics missing.
Next: parent=120

## Iter 79: failed
Node: id=123, parent=116
Mode/Strategy: explore
Config: lr_W=6.2E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=750, coeff_W_L1=3E-5, coeff_W_L2=0, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: field_R2=0.551, training_time_min=64 (partial — other metrics missing)
Embedding: N/A
Mutation: lr_W: 6.5E-4 -> 6.2E-4 at W_L2=0 (N116 baseline)
Parent rule: N116 had V_rest=0.511 at lr_W=6.5E-4, testing intermediate lr_W
Observation: **INFRASTRUCTURE FAILURE** — training completed, field_R2=0.551. Training appears successful but metrics calculation failed.
Next: parent=120

## Iter 80: failed
Node: id=124, parent=77
Mode/Strategy: principle-test
Config: lr_W=7E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=1000, coeff_W_L1=4E-5, coeff_W_L2=0, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: field_R2=0.550, training_time_min=63 (partial — other metrics missing)
Embedding: N/A
Mutation: edge_diff: 750 -> 1000 at lr_W=7E-4, W_L1=4E-5. Testing principle: "edge_diff=1000 helps V_rest across configs"
Parent rule: N77 has best cluster (0.894), testing if edge_diff=1000 transfers benefit
Observation: **INFRASTRUCTURE FAILURE** — training completed, field_R2=0.550. Testing if edge_diff=1000 benefit generalizes beyond lr_W=6E-4.
Next: parent=120

---

### Batch 21 Summary
| Slot | Node | Mutation | field_R2 | Time | Status |
|------|------|----------|----------|------|--------|
| 0 | N121 | edge_diff: 1000 -> 1100 | 0.549 | 64 | FAILED (metrics) |
| 1 | N122 | EXACT REPLICATE N120 | 0.552 | 64 | FAILED (metrics) |
| 2 | N123 | lr_W: 6.5E-4 -> 6.2E-4 | 0.551 | 64 | FAILED (metrics) |
| 3 | N124 | edge_diff: 750 -> 1000 at lr_W=7E-4 | 0.550 | 63 | FAILED (metrics) |

**Key Observations:**
1. **All 4 slots failed due to metrics calculation** — training completed (~63-64 min each)
2. **field_R2 consistent at ~0.55** — suggests training was successful
3. **No conclusions can be drawn** without connectivity_R2, tau_R2, V_rest_R2, cluster_accuracy
4. **Next batch should re-run similar configs** to test hypotheses

---

### Batch 22 (Iter 81-84): Infrastructure Failure (SECOND CONSECUTIVE)

## Iter 81: failed
Node: id=125, parent=120
Mode/Strategy: exploit (replication)
Config: lr_W=6E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=1000, coeff_W_L1=3E-5, coeff_W_L2=2E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: FAILED (empty analysis log)
Embedding: N/A
Mutation: EXACT REPLICATE N120 (edge_diff=1000, W_L2=2E-6, V_rest=0.547)
Parent rule: Re-run to get full metrics after Batch 21 failure
Observation: **INFRASTRUCTURE FAILURE** — no metrics available, not even field_R2. Second consecutive batch failure.
Next: parent=120

## Iter 82: failed
Node: id=126, parent=120
Mode/Strategy: exploit
Config: lr_W=6E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=1100, coeff_W_L1=3E-5, coeff_W_L2=2E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: FAILED (empty analysis log)
Embedding: N/A
Mutation: edge_diff: 1000 -> 1100 at N120 baseline
Parent rule: Re-test edge_diff=1100 with working metrics
Observation: **INFRASTRUCTURE FAILURE** — no metrics available. Unable to determine if edge_diff=1100 helps.
Next: parent=120

## Iter 83: failed
Node: id=127, parent=95
Mode/Strategy: explore (UCB=4.204)
Config: lr_W=5.9E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=900, coeff_W_L1=3E-5, coeff_W_L2=1E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: FAILED (empty analysis log)
Embedding: N/A
Mutation: High UCB exploration at N95 baseline (edge_diff=900, W_L2=1E-6 at lr_W=5.9E-4)
Parent rule: N95 UCB=4.204 (highest) — test edge_diff=900 + W_L2=1E-6 stability
Observation: **INFRASTRUCTURE FAILURE** — no metrics available. High UCB node exploration wasted.
Next: parent=95

## Iter 84: failed
Node: id=128, parent=94
Mode/Strategy: principle-test
Config: lr_W=6E-4, lr=1.2E-3, lr_emb=1.5E-3, lr_siren=1E-8, coeff_edge_diff=900, coeff_W_L1=3E-5, coeff_W_L2=2E-6, batch_size=1, hidden_dim=64, hidden_dim_nnr_f=2048, omega_f=2048, recurrent=F
Metrics: FAILED (empty analysis log)
Embedding: N/A
Mutation: REPLICATE N94 (field=0.638 outlier). Testing principle: "N94's field=0.638 was a statistical outlier"
Parent rule: Attempt to reproduce N94's exceptional field_R2=0.638
Observation: **INFRASTRUCTURE FAILURE** — unable to test outlier reproducibility.
Next: parent=94

---

### Batch 22 Summary
| Slot | Node | Mutation | Metrics | Status |
|------|------|----------|---------|--------|
| 0 | N125 | EXACT REPLICATE N120 | NONE | FAILED |
| 1 | N126 | edge_diff: 1000 -> 1100 | NONE | FAILED |
| 2 | N127 | UCB exploration at N95 | NONE | FAILED |
| 3 | N128 | REPLICATE N94 outlier | NONE | FAILED |

**Critical Issue:**
- **Second consecutive infrastructure failure** — Batch 21 had partial metrics (field_R2 only), Batch 22 has NO metrics at all
- This may indicate a worsening infrastructure problem
- No experimental conclusions can be drawn
- Next batch should continue attempting the same experiments while hoping infrastructure is fixed
