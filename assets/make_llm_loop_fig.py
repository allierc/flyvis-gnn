...
Run once to create the static asset; Notebook_06 and index.qmd display the SVG.
...
# ── Agent box ──
rounded_box(4.0, 2.6, 2.6, 1.6, c_agt, url="../Notebook_06.html")
...
rounded_box(4.0, -0.1, 2.6, 1.6, c_mem, url="../Notebook_06.html#research-summary")
