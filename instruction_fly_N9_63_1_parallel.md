# Parallel Mode Addendum — FlyVis (fly_N9_63_1, learned visual field)

This addendum applies when running in **parallel mode** (GNN_LLM_parallel_flyvis.py). Follow all rules from the base instruction file (`instruction_fly_N9_63_1.md`), with these modifications.
