# FlyVis GNN Training Exploration — flyvis_62_1 (DAVIS + noise)

**Reference**: See `papers/cosyne2026.tex` for model and regularization context.

## Goal

Optimize GNN training hyperparameters for the **Drosophila visual system** (flyvis_62_1, DAVIS + noise).
...
- `flyvis_62_1` (DAVIS + noise 0.05): connectivity_R2=0.95, tau_R2=0.80, V_rest_R2=0.40 (with full regularization, 10 epochs)
- `flyvis_62_1` with noise + Sintel: R²_W=0.99, tau_R2=1.00, V_rest_R2=0.85
